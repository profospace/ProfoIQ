...
const placeholderUsers = [
    ...
    { id: 2, name: "User 2", phone: "9876543210" },
];

const placeholderActivities = [
    { userId: 1, propertyId: 1, activity: "Visited", timestamp: "2023-12-20", saved: true, contacted: false },
    { userId: 2, propertyId: 2, activity: "Saved", timestamp: "2023-12-20", saved: true, contacted: true },
];
