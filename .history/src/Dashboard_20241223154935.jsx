...
const Dashboard = () => {
    ...
    const chartData = {
        ...
        datasets: [
            {
                label: 'Number of Visits',
                data: properties.map(property => property?.visted || 0.5), // Use 0.5 for "No visits"
            ...
            tooltip: {
                callbacks: {
                    label: function (tooltipItem) {
                        ...
                        return value <= 0.5 ? 'No visits till now' : `Visits: ${value}`;
                    },
                },
            },
        },
            ...
            y: {
                ticks: {
                    callback: function (value) {
                        // Hide the placeholder value from Y-axis labels
