...
const PropertiesTable = () => {
    ...
    useEffect(() => {
        ...
        axios.get("/api/properties")
            .then((response) => {
                console.log("API Response for Properties:", response.data); // Debugging line
                setProperties(Array.isArray(response.data) ? response.data : []);
            })
            .catch((error) => {
                console.error("Error fetching properties:", error);
                // Keep using placeholder data if API request fails
            });
    }, []);
...
const UsersTable = () => {
    ...
    useEffect(() => {
        ...
        axios.get("/api/users")
            .then((response) => {
                console.log("API Response for Users:", response.data); // Debugging line
...
const UserPropertyActivitiesTable = () => {
    ...
    useEffect(() => {
        ...
        axios.get("/api/activities")
            .then((response) => {
                console.log("API Response for Activities:", response.data); // Debugging line
